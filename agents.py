...
basic_generator_template= """
    ...
    例如年龄对说话有很大影响，年纪小可能很多事表述不清，会有恐惧、反抗情绪，语法简单，逻辑单一；而年龄大语言能力强，有较强的自主思想
    依从性高低会影响来访者是否愿意配合咨询师聊天的程度
    是否是自愿来咨询也同样是影响配合咨询师聊天的程度，如果非自愿，可能愿意袒露心扉的概率就更小
    综上，最好结合一定心理学知识，分析这个来访者可能有的说话特点和沟通风格，预测这场咨询中这个来访者的大致走向与态度，生成30字左右的描述"""
